...
// ─────────────────────────────────────────────
// 全社統一給与テーブル（16期人事制度・給与テーブルC）
// 等級 A〜G（役職）× 行（テーブルA:1〜9 / 基準:0 / テーブルB:10〜18）。
// 昇級=行を上へ（上げピッチ反映済）、降級=行を下へ（下げピッチ反映済）。
// ※CRM事業部は本テーブル対象外（事業部設定に準ずる）。
// ─────────────────────────────────────────────
export interface SalaryGrade {
  grade: string; // A〜G
  role: string; // 役職
  upPitch: number; // 上げピッチ
  downPitch: number; // 下げピッチ
}

export const SALARY_GRADES: SalaryGrade[] = [
  { grade: "A", role: "一般", upPitch: 10000, downPitch: 8000 },
  { grade: "B", role: "リーダー", upPitch: 10000, downPitch: 10000 },
  { grade: "C", role: "SV", upPitch: 15000, downPitch: 10000 },
  { grade: "D", role: "マネージャー", upPitch: 20000, downPitch: 15000 },
  { grade: "E", role: "部長", upPitch: 35000, downPitch: 25000 },
  { grade: "F", role: "事業部長", upPitch: 35000, downPitch: 35000 },
  { grade: "G", role: "執行役員", upPitch: 50000, downPitch: 40000 },
];

/** ラダー上の行順（上＝高給→下＝低給）。基準0は中央。 */
export const SALARY_ROW_ORDER = [1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 10, 11, 12, 13, 14, 15, 16, 17, 18];

/** SALARY_TABLE[grade][row] = 月の総支給額 */
export const SALARY_TABLE: Record<string, Record<number, number>> = {
  A: { 1: 345000, 2: 335000, 3: 325000, 4: 315000, 5: 305000, 6: 295000, 7: 285000, 8: 275000, 9: 265000, 0: 255000, 10: 247000, 11: 239000, 12: 231000, 13: 223000, 14: 215000, 15: 207000, 16: 199000, 17: 191000, 18: 183000 },
  B: { 1: 460000, 2: 450000, 3: 440000, 4: 430000, 5: 420000, 6: 410000, 7: 400000, 8: 390000, 9: 380000, 0: 370000, 10: 360000, 11: 350000, 12: 340000, 13: 330000, 14: 320000, 15: 310000, 16: 300000, 17: 290000, 18: 280000 },
  C: { 1: 585000, 2: 570000, 3: 555000, 4: 540000, 5: 525000, 6: 510000, 7: 495000, 8: 480000, 9: 465000, 0: 450000, 10: 440000, 11: 430000, 12: 420000, 13: 410000, 14: 400000, 15: 390000, 16: 380000, 17: 370000, 18: 360000 },
  D: { 1: 720000, 2: 700000, 3: 680000, 4: 660000, 5: 640000, 6: 620000, 7: 600000, 8: 580000, 9: 560000, 0: 540000, 10: 525000, 11: 510000, 12: 495000, 13: 480000, 14: 465000, 15: 450000, 16: 435000, 17: 420000, 18: 405000 },
  E: { 1: 1095000, 2: 1060000, 3: 1025000, 4: 990000, 5: 955000, 6: 920000, 7: 885000, 8: 850000, 9: 815000, 0: 780000, 10: 755000, 11: 730000, 12: 705000, 13: 680000, 14: 655000, 15: 630000, 16: 605000, 17: 580000, 18: 555000 },
  F: { 1: 1315000, 2: 1280000, 3: 1245000, 4: 1210000, 5: 1175000, 6: 1140000, 7: 1105000, 8: 1070000, 9: 1035000, 0: 1000000, 10: 965000, 11: 930000, 12: 895000, 13: 860000, 14: 825000, 15: 790000, 16: 755000, 17: 720000, 18: 685000 },
  G: { 1: 1700000, 2: 1650000, 3: 1600000, 4: 1550000, 5: 1500000, 6: 1450000, 7: 1400000, 8: 1350000, 9: 1300000, 0: 1250000, 10: 1210000, 11: 1170000, 12: 1130000, 13: 1090000, 14: 1050000, 15: 1010000, 16: 970000, 17: 930000, 18: 890000 },
};
